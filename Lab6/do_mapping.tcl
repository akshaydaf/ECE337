...
analyze -format sverilog -lib WORK {edge_detect.sv eop_detect.sv decode.sv rx_fifo.sv shift_register.sv rcu.sv timer.sv sync_low.sv sync_high.sv posedge_detect.sv flex_counter.sv flex_stp_sr.sv usb_receiver.sv}
